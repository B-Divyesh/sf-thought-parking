...
The demo starts with three realistic interruption thoughts: two waiting for review and one already promoted. You can capture, review, archive, promote, export, or reset them without affecting your own thoughts.
...
Use **Reset demo** to restore the shipped sample. Use **Start for real** to leave the sandbox; this discards the demo view and opens the ordinary local app.
